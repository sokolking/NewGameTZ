...
/// <summary>
/// Вкладки «Аудио» / «Видео» в SettingsPanel (EscScene). Имена дочерних объектов см. меню Tools → Esc Scene → Setup Settings Panel Tabs, либо задайте ссылки в инспекторе.
/// </summary>
